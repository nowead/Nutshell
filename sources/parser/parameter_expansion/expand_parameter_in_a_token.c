...
/*   Updated: 2024/07/15 15:39:48 by seonseo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

int expand_parameters_in_a_token(t_toknode *toknode, t_tokenlist *tokenlist, t_shell_ctx *shell_ctx)
{
...
t_tokenlist	*split_into_subtokens_and_expand(t_toknode *toknode, t_shell_ctx *shell_ctx)
{
    t_tokenlist *subtokenlist;
...
int insert_or_pop_fields(t_tokenlist *tokenlist, t_toknode *toknode, t_tokenlist *splited_fields)
{
